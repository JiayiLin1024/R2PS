...
def main():
    ...
    parser.add_argument("--output_dir_sia_model", default="saved_model/unixcoder/cosqa/", type=str, 
                        help="The saved model checkpoint.")
    parser.add_argument("--output_dir_mono_model", default="saved_model/unixcoder_RR/cosqa/", type=str, 
                        help="The saved model checkpoint.")
    ...
    mono_model = Unixcoder_RR(RobertaModel.from_pretrained(args.model_name_or_path)) # , cosqa_flag= 'cosqa' in  args.train_data_file, query_len=args.nl_length
