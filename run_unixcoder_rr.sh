...
do
    if [ $dataset == CSN ]
    then
        langs=(ruby javascript go python java php) #  javascript go python java php
    else
        langs=(python)
    fi
    ...
    do
        ...
        then
            ...
            output_dir_mono_model=saved_model/unixcoder_rr/$dataset/$lang/
        ...
        then
            ...
            output_dir_mono_model=saved_model/unixcoder_rr/$dataset/
        ...
        python run_unixcoder_rr.py \
            ...
            --atK 10 \
            --with_training \
            --log log/unixcoder_rr/${dataset}_${lang}_final.log 
